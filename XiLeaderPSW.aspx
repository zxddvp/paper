<%@ Page Language="C#" AutoEventWireup="true" CodeFile="XiLeaderPSW.aspx.cs" Inherits="XiLeaderPSW" %>
...
<body style="margin-top: 0px; margin-bottom: 0px; margin-right:0px; margin-left:0px" class="css">
    ...
    <td>
        <table style="width: 560px; height: 620px; background-color: #dee9f9;" border="0" cellpadding="0" cellspacing="0" class="css">
                                             ...
                                             <tr>
                                                <td align="right" style="width: 169px">
                                                    <asp:Label ID="Label1" runat="server" AssociatedControlID="StunoTBox"
                                                        Font-Size="Larger">用户名：</asp:Label></td>
                                                <td>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="StunoTBox"
                                                        ErrorMessage="必须填写“用户名”。" ToolTip="必须填写“用户名”。" ValidationGroup="ChangePassword1">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right" style="width: 169px">
