<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeaPinfen.aspx.cs" Inherits="TeaPinfen" %>
        ...
        <table style="width: 680px; " border="0" cellpadding="0" cellspacing="0" class="css">
            ...
            <tr style="height: 8px">
                ...
                <table cellspacing="0"  width="100%" ="center" border="0">
												...
												<tr>
													<td align="left">您好！<%=teaname%>，请为您指导学生的论文评分 ：</td>
												</tr>
				</table>
                    </td>
            ...
            <tr style="height: 440px">
                ...
                <asp:DataGrid ID="gvStuPingfen" runat="server" AutoGenerateColumns="False" 
                        ...
                        OnPageIndexChanged="gvStuPingfen_PageIndexChanged" 
                        onitemcommand="gvStuPingfen_ItemCommand" 
                        ...
                        <asp:BoundColumn DataField="ID" Visible="false"></asp:BoundColumn>
                            ...
                            <asp:BoundColumn DataField="pingfen_Zong" HeaderText="指导教师评分总分">
