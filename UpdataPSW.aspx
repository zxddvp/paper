<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdataPSW.aspx.cs" Inherits="UpdataPSW" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
    <title>学生更改密码页面</title>
                                             ...
                                             <tr>
                                                <td align="right" style="width: 169px">
                                                    <asp:Label ID="Label1" runat="server" AssociatedControlID="StunoTBox"
                                                        Font-Size="Larger">学   号：</asp:Label></td>
                                                <td>
                                                    <asp:TextBox ID="StunoTBox" runat="server" Font-Size="0.8em" TextMode="SingleLine" Enabled="false"
                                            ...
                                            <tr>
                                                <td align="right" style="width: 169px">
                                                    <asp:Button ID="ChangePasswordPushButton" runat="server" BackColor="White" BorderColor="#C5BBAF"
                                                        ...
                                                        Font-Size="Larger" ForeColor="#1C5E55" Height="31px" OnClick="ChangePasswordPushButton_Click"
                                                        Text="更改密码" ValidationGroup="ChangePassword1" Width="105px" />
                                                </td>
                                                <td>
                                                    <asp:Button ID="CancelPushButton" runat="server" BackColor="White" BorderColor="White"
                                                        BorderStyle="Solid" BorderWidth="2px" CausesValidation="False" CommandName="Cancel"
                                                        Font-Names="Verdana" Font-Size="Larger" ForeColor="#1C5E55" OnClick="CancelPushButton_Click"
                                                        Text="取  消" Height="32px" Width="73px" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
