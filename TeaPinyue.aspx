<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TeaPinyue.aspx.cs" Inherits="TeaPinyue" %>
        ...
        <table style="width: 680px; " border="0" cellpadding="0" cellspacing="0" class="css">
            ...
            <tr style="height: 8px">
                ...
                <table cellspacing="0"  width="100%" ="center" border="0">
												...
												<tr>
													<td align="left">您好！<%=teaname%>，请为您指导学生的论文评阅：</td>
												</tr>
				</table>
                    </td>
            ...
            <tr style="height: 440px">
                ...
                <asp:DataGrid ID="gvJysPingyue" runat="server" AutoGenerateColumns="False" 
                        ...
                        OnPageIndexChanged="gvJysPingyue_PageIndexChanged" 
                        onitemcommand="gvJysPingyue_ItemCommand" 
                        ...
                        <asp:BoundColumn DataField="Tea_Name" HeaderText="指导教师姓名">
                            ...
                            <asp:BoundColumn DataField="pingyue_Zong" HeaderText="评阅总分">
